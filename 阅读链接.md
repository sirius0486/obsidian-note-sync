...
```json
{
  ...
  "criteria": [
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:exposes-contract:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:architecture-doco-exists:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:single-source-of-truth-data:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:single-responsibility:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:architecture-doco-in-git:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:no-wheel-re-invent:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:language-not-in-retire:1.0",
      "comment": "enzyme for testing is a little bit outdated and less popular compare to `React Testing Library`   such Testing framework"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:containerised-environments:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:supported-library-and-framework:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:ci-fully-scripted:2.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:language-in-adopt:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:two-or-more-authors:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:three-or-more-deployments:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:linting:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:continuous-deployment:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:1pagers-exist:2.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:logs-centrally-aggregated:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:logs-have-adequate-info:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:security-controls-exist-and-tested:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:infra-as-code-no-click-ops:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:dr-plan-exists:1.0"
    },
    {
      "answer": "A",
      "criterion": "urn:rea:systems-health:criterion:security-controls-exist-critical-systems:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:alerting-exists:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:right-sizing-analysis:1.0"
    },
    {
      "answer": "A",
      "criterion": "urn:rea:systems-health:criterion:dr-plan-has-been-tested:1.0"
    },
    {
      "answer": "Y",
      "criterion": "urn:rea:systems-health:criterion:operational-targets-met:1.0"
    }
  ]
}
```